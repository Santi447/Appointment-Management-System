...
def find_appointments_by_time(object_list,day_of_week,start_time):
        ...
        # print(f"Appointment: {object.get_day_of_week()} {object.get_start_time} - {object.get_end_time} for {object.get_client_name} Has been Cancelled!")
        #     #   return object
...
def main():
    ...
    print(appt)
    print(appt2)
    find_appointments_by_time(object_list,"Thursday", 11)
    # if result:
    #     print(f"Appointment: {object.get_day_of_week()} {object.get_start_time_hour()} - {object.get_end_time_hour()} for {object.get_client_name()} Has been Cancelled!")
    # else:
    #     print("That time slot isn't booked and doesn't need to be cancelled")          
